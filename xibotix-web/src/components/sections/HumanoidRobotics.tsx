...
export function HumanoidRobotics() {
  ...
  return (
    <section id="robotics" className="py-32 bg-background border-t border-white/5 relative">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="flex-1 w-full lg:w-1/2">
            ...
            >
              ...
              <div className="relative z-10 w-48 h-64 border border-white/20 bg-background/50 backdrop-blur-md rounded-t-[4rem] rounded-b-2xl shadow-2xl flex flex-col items-center pt-8 overflow-hidden group-hover:border-accent/50 transition-colors duration-500">
                <div className="w-16 h-8 bg-black rounded-full mb-8 relative border border-white/10 flex items-center justify-center gap-2">
                    <div className="w-2 h-2 rounded-full bg-accent animate-pulse" />
                    <div className="w-2 h-2 rounded-full bg-accent animate-pulse" style={{ animationDelay: "0.2s"}} />
                </div>
                <div className="w-24 h-full bg-white/5 border-t border-white/10 rounded-t-3xl" />
              </div>
            </motion.div>
          </div>
        </div>
