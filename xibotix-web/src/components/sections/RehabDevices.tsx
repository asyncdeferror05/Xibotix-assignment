...
export function RehabDevices() {
  ...
  return (
    <section id="rehab" className="py-16 md:py-32 relative border-t border-black/5">
          ...
          <div className="flex-1 w-full lg:w-1/2">
            ...
            >
              ...
              <div className="relative z-10 w-24 h-72 flex flex-col items-center">
                <div className="w-16 h-24 bg-black/5 border border-black/10 rounded-t-3xl backdrop-blur-md relative overflow-hidden group-hover:border-accent/50 transition-colors duration-500">
                    <div className="absolute top-2 left-1/2 -translate-x-1/2 w-8 h-2 bg-accent/30 rounded-full" />
                </div>
                {/* Joint */}
                <div className="w-20 h-20 bg-background border border-black/20 rounded-full my-1 z-20 shadow-2xl flex items-center justify-center group-hover:border-accent/50 transition-colors duration-500">
                  <div className="w-8 h-8 rounded-full border border-accent/40 flex items-center justify-center">
                     <div className="w-2 h-2 rounded-full bg-accent animate-pulse" />
                  </div>
                </div>
                <div className="w-12 h-32 bg-black/5 border border-black/10 rounded-b-3xl backdrop-blur-md relative overflow-hidden group-hover:border-accent/50 transition-colors duration-500">
