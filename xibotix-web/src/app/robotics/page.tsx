...
import { ArrowRight, Brain, Eye, Cpu, Crosshair, Network, Activity } from "lucide-react";

export default function RoboticsPage() {
  return (
    <main className="min-h-screen relative">
      {/* Cinematic Hero */}
      <section className="relative min-h-[85vh] text-foreground flex flex-col justify-center overflow-hidden pt-32 pb-16 px-6">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-black via-[#050505] to-[#020202] z-[-2]" />
      ...
      {/* Overview */}
      <section id="technologies" className="py-24 md:py-32 relative border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {["Artificial Intelligence", "Computer Vision", "Embedded Systems", "Precision Motion Control", "Mechanical Design", "Human Machine Interaction"].map((item, idx) => (
              <div key={idx} className="p-8 border border-white/10 rounded-2xl bg-white/5 hover:bg-white/10 transition-colors">
      ...
      <section className="py-24 md:py-32 relative">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 p-10 rounded-3xl bg-white/5 border border-white/10 shadow-sm hover:shadow-md transition-shadow">
            ...
            {/* Computer Vision */}
            <div className="p-10 rounded-3xl bg-white/5 border border-white/10 shadow-sm hover:shadow-md transition-shadow">
          ...
          <div className="flex flex-col md:flex-row items-start gap-16">
            ...
            <div className="md:w-2/3 flex flex-wrap gap-3">
              {["Python", "ROS2", "OpenCV", "YOLO", "CUDA", "TensorFlow", "PyTorch", "NVIDIA Jetson", "Embedded Linux", "Real-Time Systems"].map((tech, i) => (
                <div key={i} className="px-6 py-3 border border-white/10 rounded-full text-sm font-medium bg-white/5 text-foreground">
                  {tech}
                </div>
              ))}
            </div>
      ...
      <section className="py-24 md:py-32 text-foreground relative">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-20">
          <div>
            <h3 className="text-2xl font-bold mb-8 text-foreground">Industrial Integration</h3>
          ...
          <div className="flex flex-col justify-center">
            <h2 className="text-sm font-semibold tracking-widest text-foreground/50 uppercase mb-6">Product Philosophy</h2>
            <p className="text-3xl md:text-5xl font-medium tracking-tight leading-tight text-balance text-foreground">
